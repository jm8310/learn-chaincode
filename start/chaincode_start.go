...
//==============================================================================================================================
//	Product - Defines the structure for a Mobile object. JSON on right tells it what JSON fields to map to
...
//==============================================================================================================================
//	V5C/Barcode Holder - Defines the structure that holds all the v5cIDs/Barcode for vehicles that have been created.
...
//}
type Barcode_Holder struct {
	BCNos 	[]string `json:"bcnos"`
}
//==============================================================================================================================
...
//==============================================================================================================================
//	 retrieve_v5c - Gets the state of the data at v5cID/Barcode in the ledger then converts it from the stored
//					JSON into the Vehicle/Product struct for use in the contract. Returns the Vehicle/Product struct.
//					Returns empty v if it errors.
//==============================================================================================================================
func (t *SimpleChaincode) retrieve_v5c(stub shim.ChaincodeStubInterface, barcode string) (Product, error) {
...
//				  method 'PutState'.
//==============================================================================================================================
func (t *SimpleChaincode) save_changes(stub shim.ChaincodeStubInterface, v Product) (bool, error) {
...
func (t *SimpleChaincode) Invoke(stub shim.ChaincodeStubInterface, function string, args []string) ([]byte, error) {
	...
	if function == "create_product" {
		...
		if function == "scrap_product" {																// If its a scrap vehicle/Product then only two arguments are passed (no update value) all others have three arguments and the v5cID/Barcode is expected in the last argument
			argPos = 0
		}
		...
		} else if function == "scrap_product" 		{ return t.scrap_product(stub, v, caller, caller_affiliation) }
...
func (t *SimpleChaincode) Query(stub shim.ChaincodeStubInterface, function string, args []string) ([]byte, error) {
	...
	if function == "get_product_details" {
		...
		return t.get_product_details(stub, v, caller, caller_affiliation)
	} else if function == "check_unique_v5c" {
		return t.check_unique_v5c(stub, args[0], caller, caller_affiliation)
	} else if function == "get_products" {
		return t.get_products(stub, caller, caller_affiliation)
...
//	 Create Function
//=================================================================================================================================
//	 Create Product - Creates the initial JSON for the vehcile and then saves it to the ledger.
//=================================================================================================================================
func (t *SimpleChaincode) create_product(stub shim.ChaincodeStubInterface, caller string, caller_affiliation string, barcode string) ([]byte, error) {
	var v Product

	v5c_ID         := "\"v5cID\":\"UNDEFINED\", "							// Variables to define the JSON
	vin            := "\"VIN\":0, "
	make           := "\"Make\":\"UNDEFINED\", "
	...
	if 				barcode_no  == "" 	 ||
					matched == false    {
																		fmt.Printf("CREATE_VEHICLE: Invalid v5cID/ Barcode provided");
																		return nil, errors.New("Invalid v5cID/Barcode provided")
	}

	err = json.Unmarshal([]byte(product_json), &v)							
	// Convert the JSON defined above into a vehicle/Product object for go
...
//=================================================================================================================================
func (t *SimpleChaincode) authority_to_manufacturer(stub shim.ChaincodeStubInterface, v Product, caller string, caller_affiliation string, recipient_name string, recipient_affiliation string) ([]byte, error) {
...
//=================================================================================================================================
func (t *SimpleChaincode) manufacturer_to_private(stub shim.ChaincodeStubInterface, v Product, caller string, caller_affiliation string, recipient_name string, recipient_affiliation string) ([]byte, error) {
	...
	if 		v.Make 	 == "UNDEFINED" ||
			...
			v.VIN == 0				{					//If any part of the car is undefined it has not bene fully manufacturered so cannot be sent
															fmt.Printf("MANUFACTURER_TO_PRIVATE: Mobile not fully defined")
															return nil, errors.New(fmt.Sprintf("Mobile not fully defined. %v", v))
	}
...
//	 private_to_private
//=================================================================================================================================
func (t *SimpleChaincode) private_to_private(stub shim.ChaincodeStubInterface, v Product, caller string, caller_affiliation string, recipient_name string, recipient_affiliation string) ([]byte, error) {
...
//=================================================================================================================================
func (t *SimpleChaincode) private_to_lease_company(stub shim.ChaincodeStubInterface, v Product, caller string, caller_affiliation string, recipient_name string, recipient_affiliation string) ([]byte, error) {
...
//=================================================================================================================================
func (t *SimpleChaincode) lease_company_to_private(stub shim.ChaincodeStubInterface, v Product, caller string, caller_affiliation string, recipient_name string, recipient_affiliation string) ([]byte, error) {
...
//=================================================================================================================================
func (t *SimpleChaincode) private_to_scrap_merchant(stub shim.ChaincodeStubInterface, v Product, caller string, caller_affiliation string, recipient_name string, recipient_affiliation string) ([]byte, error) {
...
//	 update_vin
//=================================================================================================================================
func (t *SimpleChaincode) update_vin(stub shim.ChaincodeStubInterface, v Product, caller string, caller_affiliation string, new_value string) ([]byte, error) {
...
//	 update_registration
//=================================================================================================================================
func (t *SimpleChaincode) update_registration(stub shim.ChaincodeStubInterface, v Product, caller string, caller_affiliation string, new_value string) ([]byte, error) {
...
//	 update_colour
//=================================================================================================================================
func (t *SimpleChaincode) update_colour(stub shim.ChaincodeStubInterface, v Product, caller string, caller_affiliation string, new_value string) ([]byte, error) {
...
//	 update_make
//=================================================================================================================================
func (t *SimpleChaincode) update_make(stub shim.ChaincodeStubInterface, v Product, caller string, caller_affiliation string, new_value string) ([]byte, error) {
...
//	 update_model
//=================================================================================================================================
func (t *SimpleChaincode) update_model(stub shim.ChaincodeStubInterface, v Product, caller string, caller_affiliation string, new_value string) ([]byte, error) {
...
//	 scrap_vehicle
//=================================================================================================================================
func (t *SimpleChaincode) scrap_product(stub shim.ChaincodeStubInterface, v Product, caller string, caller_affiliation string) ([]byte, error) {
	...
	if		v.Status			== STATE_BEING_SCRAPPED	&&
		...
		return nil, errors.New("Permission denied. scrap_product")
	}
...
//	 get_product_details
//=================================================================================================================================
func (t *SimpleChaincode) get_product_details(stub shim.ChaincodeStubInterface, v Product, caller string, caller_affiliation string) ([]byte, error) {
	...
	if 		v.Owner				== caller		||
			caller_affiliation	== AUTHORITY	{
					...
					return bytes, nil
																...
																return nil, errors.New("Permission Denied. get_product_details")
	}
...
func (t *SimpleChaincode) get_products(stub shim.ChaincodeStubInterface, caller string, caller_affiliation string) ([]byte, error) {
	bytes, err := stub.GetState("barcodes")
